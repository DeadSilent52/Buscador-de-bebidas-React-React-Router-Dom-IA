...
export default function GenerateAI() {
  ...
  const generateRecipe = useApppStore(state => state.generateRecipe)
  const recipe = useApppStore(state => state.recipe)
  const isGenerating = useApppStore(state => state.isGenerating)
